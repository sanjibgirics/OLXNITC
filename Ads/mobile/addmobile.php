...
//	echo "g";
$sql= "INSERT INTO product (pname,price,doi,status,ptype,uuid,img1) VALUES ('$_POST[pname]',$_POST[price],CURDATE(),'available','mobile',$a,'$img1')";
...
//				exit('not updated');
		...
		*/
		...
		//insert laptops
		$query="INSERT INTO mobile(mpid,mmodel,myop) values($itemId,'$_POST[model]','$_POST[myop]')";
