...
//	echo "g";
$sql= "INSERT INTO product (pname,price,doi,status,ptype,uuid,img1) VALUES ('$_POST[pname]',$_POST[price],CURDATE(),'available','book',$a,'$img1')";
...
//	echo $sql;
      ...
      //echo "New record created successfully";
		...
		$query="INSERT INTO author(apid,author) values($itemId,'$author1')";
		...
		$query="INSERT INTO author(apid,author) values($itemId,'$author2')";
		$result=mysqli_query($conn,$query);
		}
		if($_POST['author3']!=""){
		$author3=$_POST['author3'];
		$query="INSERT INTO author(apid,author) values($itemId,'$author3')";
		$result=mysqli_query($conn,$query);
		}

		if($_POST['author4']!=""){
		$author4=$_POST['author4'];
		$query="INSERT INTO author(apid,author) values($itemId,'$author4')";
		$result=mysqli_query($conn,$query);
		}
		
		$bcondition = $_POST['bcondition'];
		$query="INSERT INTO book(bpid,bcondition) values($itemId,'$bcondition');";
		$result=mysqli_query($conn,$query);
